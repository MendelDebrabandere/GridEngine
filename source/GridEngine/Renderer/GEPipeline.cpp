...
void GEPipeline::bind(VkCommandBuffer commandBuffer)
{
	vkCmdBindPipeline(commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, graphicsPipeline);
}

void GEPipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo) {
...
void GEPipeline::createGraphicsPipeline(const std::string& vertFilepath, const std::string& fragFilepath, const PipelineConfigInfo& configInfo) {
	...
	auto bindingDescriptions = GEModel::Vertex::getBindingDescriptions();
	auto attributeDescriptions = GEModel::Vertex::getAttributeDescriptions();
	...
	if (vkCreateGraphicsPipelines(geDevice.device(), VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &graphicsPipeline) != VK_SUCCESS) {
